      ...
      <img src={lines} alt="lines" className="lines" />
        <div className="container">
          ...
          <div className="about-content">
            <p>I am Jatin Singh, a dedicated PHP Web Developer in Delhi NCR with a passion for creating dynamic and visually appealing websites. Over the past 3+ years, I have honed my skills through practical experience and academic achievements, graduating with a Bachelor of Science degree from IGNOU University in 2024.</p>
